...
from ....extractor import CDMFKC_Extractor
...
class CDMFKC(_CognitiveDiagnosisModel):
    ...
    def build(self, if_type='cdmfkc', g_impact_a=0.5, g_impact_b=0.5, hidden_dims: list = None, dropout=0.5,
              device="cpu",
              dtype=torch.float32, **kwargs):
        if hidden_dims is None:
            hidden_dims = [512, 256]

        self.extractor = CDMFKC_Extractor(
